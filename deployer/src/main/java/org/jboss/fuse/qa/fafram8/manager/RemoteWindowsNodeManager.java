...
/**
 * Specific remote node manager for Windows deployments.
 *
 * @author : Roman Jakubco (rjakubco@redhat.com)
 */
@Slf4j
public class RemoteWindowsNodeManager implements RemoteNodeManager {
	// File separator
	 ...
	 */
	public RemoteWindowsNodeManager(Executor nodeExecutor, Executor fuseExecutor) {
